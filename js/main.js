...
function initForm(_form) {
    _form.addEventListener('submit', (e) => {
            ...
            switch (input.getAttribute('name')) {
                ...
                case 'arrival_time':
                    if (input.validity.valid) {
                        ...
                        setErrorInput(input, hint, 'Укажите время для звонка');
                        return false;
                    }
                    break;
                ...
                case 'arrival_date':
                    if (input.validity.valid) {
                        ...
                        setErrorInput(input, hint, 'Укажите дату заезда');
                        return false;
                    }
                    break;
                default:
        ...
        function showPopUpSuccess(_form) {
            const _container = _form.parentNode;

            const _title = _container.querySelector('.popup__title');
            _title.innerHTML = "Спасибо <br> за заявку!";

            const _text = document.createElement("p",)
            _text.innerHTML = "Скоро мы с вами свяжемся!";
            ...
            keyCode: {
                ...
                if (n === i.instance) {
                    if (i.deactivate(), i._hasScroll()) {
                        var r = t.offset().top - i.ui.offset().top, a = i.ui.scrollTop(),
                            o = i.ui.height();
